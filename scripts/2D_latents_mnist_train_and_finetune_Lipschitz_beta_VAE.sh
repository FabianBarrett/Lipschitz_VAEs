...
do
	...
	pythonw ./lnets/tasks/vae/mains/train_VAE.py ./lnets/tasks/vae/configs/mnist/2D_latents_fc_beta_VAE_bjorck.json -o model.linear.bjorck_iter=3 model.encoder_mean.l_constant=${l_constant} model.encoder_std_dev.l_constant=${l_constant} model.decoder.l_constant=${l_constant} model.KL_beta=${KL_beta} --saving_tag=${saving_tag}
